...
6. Corre `node comun/herramientas/confiabilidad.js output/trabajo/piloto.csv` (o `--kr20` si el instrumento es dicotómico) sobre los datos reales del piloto — solo si el tipo de instrumento lleva confiabilidad numérica.
