...
3. La genera como tabla Markdown en el archivo que corresponde (`output/trabajo/informe.md` o `output/trabajo/matriz-consistencia.md`), con caption nativo de Pandoc (`Table: **Tabla N.** *Título*` debajo de la tabla — aparece arriba al exportar, ver `../../comun/apa/tablas-figuras-apa.md`) y número correlativo correcto.
