...
13. El título de la tesis no se confirma sin pasar el protocolo de verificación de disponibilidad (`tesis/contenido/titulo-y-variables.md`): búsqueda en RENATI, ALICIA, Google Scholar y el repositorio de la universidad del alumno, con evidencia registrada en `output/trabajo/verificacion-titulo.md`. Nunca afirmes que un título está "100% libre" — reporta qué se buscó, dónde, en qué fecha y qué se encontró.
...
18. El formato de tablas (APA 7 puro según `comun/apa/tablas-figuras-apa.md`, o formato propio de la universidad) y la variante de numeración de títulos se deciden en `output/trabajo/brief.md` y se aplican consistentemente en todo el documento.
...
21. **No se redacta ninguna sección más allá de Metodología 3.4** sin que el instrumento tenga alfa de Cronbach ≥ 0.70 (o el umbral que el alumno confirme en `output/trabajo/brief.md`), calculado por `comun/herramientas/confiabilidad.js` sobre datos reales de un piloto aplicado por el alumno — nunca datos simulados por la IA. Ver `tesis/contenido/instrumento-y-muestra.md` y la skill `construir-instrumento`.
