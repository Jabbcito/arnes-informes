...
5. **Confiabilidad**: correr `node ../../comun/herramientas/confiabilidad.js output/trabajo/piloto.csv` (alfa de Cronbach para ítems Likert, `--kr20` si son dicotómicos). El script imprime también la correlación ítem-total corregida de cada ítem. El resultado real (no estimado) va en Metodología 3.4.
