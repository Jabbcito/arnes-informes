...
|---|---|---|
| 1 | **Matriz de consistencia** (ver `matriz-de-consistencia.md`) | El arnés, desde `output/trabajo/matriz-consistencia.md` |
...
- Insertar en `output/trabajo/informe.md` con ruta relativa para que Pandoc la incruste en el DOCX:
