...
1. **Índice de contenidos:** lo reconstruye leyendo los títulos y subtítulos reales de `output/trabajo/informe.md`. No inventa números de página ni secciones que no existen en el documento. Es un campo real de Word (`--toc` de Pandoc), no una lista de texto — se actualiza con F9.
