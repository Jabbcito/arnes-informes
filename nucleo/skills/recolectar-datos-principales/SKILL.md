...
5. Solo entonces habilita correr `node nucleo/comun/herramientas/descriptivos.js` / `node nucleo/comun/herramientas/correlacion.js` sobre `output/trabajo/datos-principales.csv` y redactar Resultados (`../../tesis/contenido/resultados.md`).
