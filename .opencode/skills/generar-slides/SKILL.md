...
1. Extrae de `trabajo/informe.md` la idea central y la evidencia clave de cada sección.
2. Arma `trabajo/slides.md` con una idea por diapositiva (no párrafos completos del informe).
